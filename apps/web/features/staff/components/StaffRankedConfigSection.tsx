        ...
        <div className="min-w-0">
          ...
          <div className="flex flex-col gap-6 px-6 py-6">
            <Alert>
              ...
              <AlertDescription>
                Archived sessions stay visible as history, become read-only,
                and cannot accept new match logs after the title or season changes.
              </AlertDescription>
            </Alert>
          ...
          <div className="grid gap-5">
            ...
            <div className="grid gap-4 text-sm">
              <div className="flex items-center justify-between gap-4">
                <span className="text-muted-foreground">Open sessions in scope</span>
