    ...
    <div className="relative isolate flex min-h-screen flex-col bg-background [font-family:var(--font-geist-sans)]">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-border/60 bg-background/85 backdrop-blur supports-backdrop-filter:bg-background/70">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          <Link
            href="/"
            className="group inline-flex items-center gap-2 rounded-md text-base font-semibold tracking-tight text-foreground transition-colors hover:text-primary focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
          >
      ...
      <main
        id="main-content"
        className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-4 pt-20 pb-20 sm:px-6 sm:pt-24 lg:px-8"
      >
        <section className="grid items-center gap-8 motion-safe:animate-in motion-safe:duration-700 motion-safe:fade-in motion-safe:slide-in-from-bottom-2 lg:grid-cols-2">
          <div className="min-w-0 space-y-8">
            <p className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-semibold tracking-wide text-primary uppercase">
        ...
        <section className="mt-20 motion-safe:animate-in motion-safe:delay-150 motion-safe:duration-700 motion-safe:fade-in motion-safe:slide-in-from-bottom-2">
          <h2
            id="features"
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-pretty text-muted-foreground sm:text-base">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {featureCards.map((feature) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-relaxed wrap-break-word text-muted-foreground">
                  {feature.description}
                </p>
              </article>
            ))}
        ...
        <section className="mt-20 pb-10 motion-safe:animate-in motion-safe:delay-200 motion-safe:duration-700 motion-safe:fade-in motion-safe:slide-in-from-bottom-2">
          <h2
            id="how-it-works"
            className="scroll-mt-24 text-2xl font-semibold tracking-tight text-balance text-foreground sm:text-3xl"
          >
