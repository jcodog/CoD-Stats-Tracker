  ...
  switch (templateName) {
    ...
    <main class="codstats-shell" data-template="matches">
      ...
      <footer class="codstats-card codstats-footer">
        <p class="codstats-footer-status" id="matches-next-status">No more matches.</p>
        <p class="codstats-note" id="matches-next-hint">Run codstats_get_match_history again to refresh this feed.</p>
      </footer>
    </main>`;
    case "rank":
      return `
