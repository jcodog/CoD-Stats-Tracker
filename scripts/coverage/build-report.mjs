...
const AUDITED_COVERAGE_FILES = [
  "apps/web/src/app/(chatgpt-app-connector)/debug/chatgpt-app-config/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/mcp/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/oauth/authorize/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/ui/codstats/matches.html/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/ui/codstats/rank.html/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/ui/codstats/session.html/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/ui/codstats/settings.html/route.ts",
  "apps/web/src/app/(chatgpt-app-connector)/ui/codstats/widget.html/route.ts",
  "apps/web/src/app/.well-known/(chatgpt-app-connector)/oauth-authorization-server/route.ts",
  "apps/web/src/app/.well-known/(chatgpt-app-connector)/openid-configuration/route.ts",
  "apps/web/src/app/.well-known/(chatgpt-app-connector)/oauth-protected-resource/route.ts",
  "apps/web/src/app/.well-known/(chatgpt-app-connector)/oauth-protected-resource/mcp/route.ts",
...
const CONNECTOR_WATCHLIST_FILES = [
  "apps/web/src/app/(chatgpt-app-connector)/oauth/revoke/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/disconnect/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/profile/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/stats/matches/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/stats/matches/[id]/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/stats/rank/ladder/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/stats/rank/progress/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/stats/session/current/route.ts",
  "apps/web/src/app/api/(chatgpt-app-connector)/app/stats/session/last/route.ts",
